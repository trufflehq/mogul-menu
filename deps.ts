...
} from "https://tfl.dev/@truffle/third-party-oauth@^0.0.35/components/oauth-iframe/mod.ts";
export type { OAuthResponse } from "https://tfl.dev/@truffle/third-party-oauth@^0.0.35/components/oauth-iframe/mod.ts";
